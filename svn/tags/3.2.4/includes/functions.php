...
if (!function_exists('am_render_lottieplayer')) {
  function am_render_lottieplayer($atts)
  {
    ...
    <dotlottie-player <?php echo esc_attr($atts['animate_on_scroll']) && esc_attr($atts['animate_on_scroll']) !== 'false' ? 'animateonscroll' : ''; ?> <?php echo esc_attr($atts['autoplay']) && esc_attr($atts['autoplay']) !== 'false' && (!esc_attr($atts['scroll']) || esc_attr($atts['scroll']) !== 'true') ? 'autoplay' : ''; ?> background="<?php echo esc_attr($atts['background']) ?? 'transparent'; ?>" <?php echo esc_attr($atts['controls']) && esc_attr($atts['controls']) !== 'false'  ? 'controls' : ''; ?> simple description="<?php echo esc_attr($atts['alt']); ?>" <?php echo esc_attr($atts['loop']) && esc_attr($atts['loop']) !== 'false' ? 'loop' : ''; ?> mode="<?php echo esc_attr(animationMode($atts['mode'])); ?>" objectfit="<?php echo esc_attr($atts['objectfit']); ?>" src="<?php echo esc_url($atts['src']); ?>" renderer="<?php echo esc_attr($atts['renderer']); ?>" segment="<?php echo esc_attr($atts['segment'] ??
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ($atts['segment_out'] &&
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      $atts['segment_out'] !== '0' ?
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      '[' . (intval($atts['segment_in']) ?? 0) . ',' . intval($atts['segment_out']) . ']' : '')); ?>" intermission="<?php echo esc_attr($atts['intermission']); ?>" speed="<?php echo esc_attr($atts['speed']); ?>" <?php echo esc_attr($atts['subframe']) && esc_attr($atts['subframe']) !== 'false' ? 'subframe' : ''; ?> direction="<?php echo esc_attr(animationDirection($atts['direction'])); ?>" data-direction="<?php echo esc_attr(animationDirection($atts['direction'])); ?>" data-mouseover="<?php echo esc_attr($atts['onmouseover']); ?>" data-mouseout="<?php echo esc_attr($atts['onmouseout']); ?>" data-click="<?php echo esc_attr($atts['onclick']); ?>" data-selector="<?php echo esc_attr(interactionSelector($atts['selector'], $atts['exclude_selector'])); ?>" data-scroll="<?php echo esc_attr($atts['scroll']); ?>" data-delay="<?php echo esc_attr($atts['delay']); ?>" data-once="<?php echo esc_attr($atts['once']); ?>">
    </dotlottie-player>
  <?php
    echo ob_get_clean();
  }
