...
if ( class_exists( '\Elementor\Widget_Base' ) && ! class_exists( 'Elementor_AAMD_Lottie' ) ) {
	class Elementor_AAMD_Lottie extends \Elementor\Widget_Base {
		...
		protected function register_controls() {
			...
			$this->add_control(
				...
				array(
					...
					'default'    => array(
						'url' => esc_url( $aamd_lottie_upload->get_default_file() ),
					),
				)
			);
		...
		protected function render() {
			...
			echo aamd_lottie_render_lottieplayer( $attrs );
		}
	...
	$args->register( new \Elementor_AAMD_Lottie() );
}
