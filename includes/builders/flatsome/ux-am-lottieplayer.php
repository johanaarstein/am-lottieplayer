...
$aamd_position_options['options']['position_x']['on_change'] = array(
	'recompile' => false,
	'class'     => 'x{{ value }} md-x{{ value }} lg-x{{ value }}',
);
$aamd_position_options['options']['position_y']['on_change'] = array(
	'recompile' => false,
		...
		'options'           => array(
			...
			'animation_options' => array(
				...
				'options' => array(
					...
					'mode'             => array(
						'type'        => 'checkbox',
						'heading'     => $aamd_pro_feature . esc_html__( 'Boomerang', 'am-lottieplayer' ),
					...
					'segment_in'       => array(
						'type'        => 'slider',
						'heading'     => $aamd_pro_feature . esc_html__( 'Choose where to start', 'am-lottieplayer' ),
						'description' => $aamd_pro_link,
						'default'     => null,
						'min'         => 0,
						'step'        => 1,
					...
					'segment_out'      => array(
						'type'        => 'slider',
						'heading'     => $aamd_pro_feature . esc_html__( 'And where to end', 'am-lottieplayer' ),
						'description' => $aamd_pro_link,
						'default'     => null,
						'min'         => 0,
						'step'        => 1,
					...
					'animateonscroll'  => array(
						'type'        => 'checkbox',
						'heading'     => $aamd_pro_feature . esc_html__( 'Animate on scroll', 'am-lottieplayer' ),
					...
					'selector'         => array(
						'type'        => 'textfield',
						'heading'     => $aamd_pro_feature . esc_html__( 'Trigger element', 'am-lottieplayer' ),
					...
					'exclude_selector' => array(
						'type'        => 'checkbox',
						'heading'     => $aamd_pro_feature . esc_html__( 'Apply interaction only to trigger element', 'am-lottieplayer' ),
						'description' => $aamd_pro_link,
						'conditions'  => 'onmouseover === "true" || onclick === "true"',
					),
			...
			'position_options'  => $aamd_position_options,
			...
			'advanced_options'  => array(
				...
				'options' => array(
					...
					'renderer'    => array(
						'type'        => 'select',
						'heading'     => $aamd_pro_feature . esc_html__( 'Renderer', 'am-lottieplayer' ),
						'description' => $aamd_pro_link,
						'default'     => 'svg',
						'options'     => array(
							'svg'    => 'SVG',
