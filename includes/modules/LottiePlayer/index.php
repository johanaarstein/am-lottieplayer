	...
	function get_fields() {
		$fields = [
			...
			'object_fit' => [
				...
				'option_category' => 'basic_option',
				'options'  => [
					'contain' => esc_html__('Contain', 'lottieplayer'),
					'cover' => esc_html__('Cover', 'lottieplayer'),
					'fill' => esc_html__('Fill', 'lottieplayer'),
					'none' => esc_html__('None', 'lottieplayer'),
				],
				'default' => 'contain',
				'toggle_slug' => 'main_content',
			],
			'renderer' => [
				'label' => esc_html__('Renderer', 'lottieplayer'),
				'description' => esc_html__('Choose renderer', 'lottieplayer'),
				'type' => 'select',
				'option_category' => 'configuration',
				'options'  => [
					'svg' => esc_html__('SVG', 'lottieplayer'),
					'canvas' => esc_html__('Canvas', 'lottieplayer'),
				],
				'default' => 'svg',
				// 'tab_slug' => 'advanced',
				'toggle_slug' => 'main_content',
